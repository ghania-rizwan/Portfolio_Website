...
const About = () => {
  ...
  return (
    <div className='about'>
      ...
      <p>
        I am Hania. A self taught web developer and graphic designer 💻.I was interested in computers from childhood,so I persued my career in software development. I don't like to be language specific, I love working 🔨💡 in different languages and exploring new stuff 🚀.
         <br /><br /><br />
